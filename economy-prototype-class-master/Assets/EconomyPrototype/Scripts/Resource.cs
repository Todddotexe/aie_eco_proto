namespace EconomyPrototype {
    ...
    using UnityEngine;
    /// <summary>
    /// The unit that will help us count the consumption of the resources
    /// </summary>
    [Serializable]
    public struct Resource {
        ...
        /// <summary>
        /// Any resource. For example it is named "A"
        /// </summary>
        [Tooltip("Any resource. For example it is named \"A\"")]
		[SerializeField]
        public float A;
        /// <summary>
        /// Any resource. For example it is named "B"
        /// </summary>
        [Tooltip("Any resource. For example it is named \"B\"")]
        [SerializeField]
        public float B;
        /// <summary>
        /// Any resource. For example it is named "C"
        /// </summary>
        [Tooltip("Any resource. For example it is named \"C\"")]
        [SerializeField]
        public float C;
